...
- Startup Performance P2 Summary-first Boot QA(시작 성능 2차 summary-first 부팅 QA): Build 99 EAS preview/internal build 완료 / Founder 실기기 QA 대기. 확인 값은 boot/Video 요청 로그의 `view=summary`, `evidenceQueryMs=0`, `thumbnailSignedUrlWallMs=0`, Home/Video first paint 속도, thumbnail placeholder 품질, Detail 진입 시 full evidence/thumbnail 보강 여부다.
