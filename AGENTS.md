...
Unless the user explicitly asks for a summary, subset, or priority-only answer,
show the full canonical list. Do not shorten the completed section to a partial
list just because the immediate discussion is about the next task.
